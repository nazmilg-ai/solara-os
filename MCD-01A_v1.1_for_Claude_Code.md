...
13\. Version History
  ...
  **Version**   **Summary**
  ...
  1.1 Draft     Corrected §7 and §11 after cross-checking against the
                first real product specification (MCD-01B-01 Roller Blinds
                v1.0): added an explicit \"Expected Usage Pattern\" note
                (Full is uncommon for product-facing services, common for
                platform-administrative ones), reclassified 6 of 12
                services in the Roller worked example from Full/Extended
                to Configured after re-applying the objective test,
